...
public class BackGround {
    ...
    BackGround (double width, double height, String type, Pane gameRoot){
        ...
        this.width = width;
        this.height = height;
        background_1 = new SceneComponent(width * 4+1,height,type,"Assets\\Scenery\\mainBackground.jpg");
        background_1.setTranslateX(-1 * (width * 2));
        background_1.setTranslateY(0);
        background_2 = new SceneComponent(width * 4+1,height,type, "Assets\\Scenery\\mainBackground.jpg");
